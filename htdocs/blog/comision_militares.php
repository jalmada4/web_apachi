...
<div class="container my-5">
  <h1 class="mb-4 text-center">Comisión Coordinadora de los “Oficiales en situación de retiro de las Fuerzas Armadas de la Nación” de la APACHI</h1>
...
<?php
echo htmlspecialchars(file_get_contents("comision_militares.txt"));
?>
    </pre>
  </div>
</div>
